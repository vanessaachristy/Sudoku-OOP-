...
public class SudokuLayoutDark extends JFrame{
	...
	//constructor of puzzle layout
	public SudokuLayoutDark(String name) {
		initComponents();
	...
	public void initComponents() {
		...
		newGameBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				frame.dispose();
				song.stop();
				SudokuLayoutDark frame = new SudokuLayoutDark(playerName);
		...
		muteBtn.setIcon(new ImageIcon("src\\Sudoku\\playwhite.png"));
		muteBtn.setBounds(700,30,40,40);
		muteBtn.setToolTipText("Mute/play the music");
		muteBtn.setBackground(new Color(46,1,70));
		muteBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(started==false) {
					...
					started=false;
					muteBtn.setIcon(new ImageIcon("src\\Sudoku\\mutewhite.png"));
					song.stop();
				}
			}
		});
		...
		timeBtn.setIcon(new ImageIcon("src\\Sudoku\\pauseWhite.png"));
		timeBtn.setBounds(620,30,40,40);
		timeBtn.setBackground(new Color(46,1,70));
		timeBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(started==false) {
					...
					started=false;
					timeBtn.setIcon(new ImageIcon("src\\Sudoku\\startWhite.png"));
					stop();
					for(int i=0; i<9; i++) {
						for(int j=0; j<9; j++){
							tfCells[i][j].setEditable(false);
							tfCells[i][j].setBackground(DARK_PURPLE);
							tfCells[i][j].setForeground(DARK_PURPLE);
						}
					}
				}
			}
		...
		hintBtn.setToolTipText("Reveal one blank cell");
		hintBtn.setBackground(OPEN_CELL_BGCOLOR);
	...
	public void hint() {		
		...
		tfCells[idxRow][idxCol].setText(puzzle[idxRow][idxCol]+"");
